...
asdf list all java semeru-openj9  # optional, see what is available
asdf install java latest:semeru-openj9-25
asdf set --home java latest:semeru-openj9-25
java -version
...
asdf reshim  # Ensure the latest executables are used
```
...
Clojure supports [LTS releases of the JVM](https://clojure.org/guides/install_clojure#java) - at present: 8, 11, 17, 21, and 25.

```bash
echo "Installing Amazon Corretto JVM"
asdf install java latest:corretto-21
asdf set --home java latest:corretto-21
```
...
To find and install the latest version of Java (JVM 21) and Clojure,
update the plugin and search like this:

```bash
echo "Updating Java and Clojure to latest versions."
