...
chapter = true
aliases = ["/snow", "/sf", "/snowflake", "/sn", "/snowsql", "/ddl", "/fdn"]
...
Table data storage is billed at a flat rate per month, and only
accessible via Snowflake queries.

**Fun fact:** _I have been informed that the micro-partition file extension `.fdn`
stands for "Flocon de Neige" which is "Flake of Snow" in French!_
...
**Study guide for COF-C03**: [learn.snowflake.com/en/certifications/snowpro-core-c03](https://learn.snowflake.com/en/certifications/snowpro-core-c03/?pdf_name=SnowProCoreStudyGuideC03)
